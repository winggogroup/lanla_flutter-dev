...
class UploadOss {
  ...
  static Future<bool> setConfig(Future<String> configCallback) async {
    String json = await configCallback;
    var deJson = jsonDecode(json);
    ossAccessKeyId = deJson['accessKeyId'];
    ossAccessKeySecret = deJson['ossAccessKeySecret'];
    expiration = deJson['expiration'];
    return true;
  }
  /**
  ...
  static Future<String> upload(
      ...
      required Future<String> configCallback,
    ...
    var bool = await setConfig(configCallback);
    // 获取签名
