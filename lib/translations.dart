...
class TranslationsMap extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'ar_AR': {
          ...
          '视频上传失败，请检查您的网络后重新上传':'فشلت عملية التنزيل , تحقق من الشبكة ثم حاول مرة أخرى',
          ...
          '填写邀请码':'دعوة الأصدقاء',
          '说说你的建议或者问题，以便我们更好的服务':'أخبرنا باقتراحاتك أو أسئلتك حتى نتمكن من تقديم خدمة أفضل',
          ...
          '解绑Google后将无法继续使用它登录该账号':'بعد إلغاء ربط Google ، لن تتمكن من استخدامه لتسجيل الدخول إلى الحساب',
          '解绑Apple ID后将无法继续使用它登录该账号':'بعد إلغاء ربط   Apple ID الخاص بك ، لن تتمكن من استخدامه لتسجيل الدخول إلى الحساب',
          '解绑Facebook后将无法继续使用它登录该账号':'بعد إلغاء ربط Facebook ، لن تتمكن من استخدامه لتسجيل الدخول إلى الحساب',
          ...
          '榜单':'جدول',
          '为了安全，请增添一个手机号到你的LanLa账号':'لضمان أمان حسابك ، يرجى إضافة رقم هاتف الجوال  إلى حساب LanLa الخاص بك',
          ...
          '最热':'الأكثر إثارة',
          '添加话题':'أضف الموضوع',
          'LanLa鼓励向上、真实、原创的内容，含以下内容的笔记将不会被推荐：':' نحن LanLa  يتم تشجيع المحتوى التصاعدي والأصلي  ، ولن يوصى باستخدام الملاحظات التي تحتوي على المحتوى التالي:',
          '1．含有不文明语言、过度性感图片；':'1. يحتوي على كلمات غير حضارية وصور مثيرة وقليلة الاحترام ؛',
          '2．含有网址链接、联系方式、二维码或售卖语言；':'2. يحتوي على روابط URL أو معلومات الاتصال أو رموز QR أو المبيعات ؛',
          '3．冒充他人身份或搬运他人作品；':'انتحال هوية شخص آخر أو نقل عمل شخص آخر ؛',
          '4．为刻意博取眼球，在标题、封面等处使用夸张表达':'4. لجذب الانتباه بشكل متعمد ، استخدم التعبيرات المبالغ فيها في العنوان والغلاف وما إلى ذلك.',
          '发布小贴士':'نصائح النشر',
          '发布到话题':'نشر الان',
          ...
          'LanLa的成长需要你的支持，我们诚恳希望能得到你的鼓励与评价，因为你的每一次鼓励能让我们做得更好。':'يحتاج نمو وتطوير تطبيق ( LanLa ) إلى دعمك ، ونأمل بصدق أن نحصل على تشجيعك وتقييمك ، لأن كل تشجيع منك يمكن أن يجعلنا نعمل بشكل أفضل.',
          ...
          '任务':'مهمة',
          '举报用户':'أبلغ عن مستخدم',
          '提供更多信息有助于举报被快速处理':'قم بتوفير المزيد من المعلومات للمساعدة في معالجة التقرير بسرعة',
          '您没有google支付功能暂时无法充值':'عفواً لاتوجد لديك خاصية Google pay  لاتستطيع شحن العملات في الوقت الحالي',
          '贝壳可以被用来给你喜欢的作品送礼物':'يمكن استخدام الأصداف كهدية للأعمال المبدعة المفضلة لديك',
          '贝壳可以用于参与LanLa平台不同时段的活动':'يمكن استخدام الأصداف للمشاركة في الأنشطة على منصة LanLa في أوقات مختلفة',
          '还没有收益哟，快去发布优质作品赢礼物吧':'لا يوجد رصيد حتى الآن ، اسرع وقم بنشر أعمال عالية الجودة لكسب الهدايا',
          '提现功能敬请期待':'خاصية سحب الرصيد ليست متوفرة ترقبوا',
          '快去发布优质作品更容易得到收益哟！':'أسرع وانشر أعمالًا عالية الجودة لتسهيل الحصول على الهدايا !',
          ...
          '审核通过后，会有LanLa客服人员在3日内联系你的':'بعد اجتياز المراجعة ، سيتصل بك موظفو خدمة عملاء LanLa في غضون 3 أيام عمل',
          '兑换成功':'نجح الاستبدال',
          '您的卡密':'الرقم السري لبطاقة الشحن',
          '你的卡密，关闭后可在奖品兑换中查看':'يمكنك الاطلاع عليه في قسم استبدال الجوائز بعد الإغلاق',
          '进行中':'قم بالتنفيذ',
          '我收到的':'استقبلت',
          '我送出的':'اهديت',
          '兑换成功':'نجح الاستبدال',
          ...
          '解绑email后将无法继续使用它登录该账号':'بعد إلغاء ربط email ، لن تتمكن من استخدامه لتسجيل الدخول إلى الحساب',
          ...
          '在LanLa某一领域持续贡献内容的用户':'المستخدمين الذين يواصلون المساهمة بالمحتوى في مجال معين على LanLa ',
          '申请认证':'وثق الحساب',
          '达人认证':'توثيق صانعة محتوى مشهورة',
          '在LanLa某一领域持续贡献优质内容的内容创作者':'صانعات المحتوى الذين يواصلون المساهمة بمحتوى عالي الجودة في مجال معين على LanLa',
          'LanLa认证特权':'توثيق الامتياز من  LanLa',
          '我们将发送一个链接到你的邮箱，点击链接即可登录注册':' سنرسل رابطًا إلى بريدك الإلكتروني، انقر على الرابط لتسجيل الدخول أو التسجيل.',
          ...
          'LanLa工作人员将在3日内审核后给你提示并给予你相应的头衔哟～':'سيعطيك فريق LanLa تذكيرًا بالمعلومات وسيمنحك لقبا مطابقًا بعد المراجعة في غضون 3 أيام ~',
          '已申请':'تم التقديم',
          '已认证':'تم التوثيق',
          '申请条件':'شروط التقديم',
          '安全验证':'التحقق الأمني',
          ...
          '由与lanla的功能升级，以后可用账号密码进行登录':'نظرًا لترقية وظيفة lanla ، يمكن استخدام الحساب وكلمة المرور لتسجيل الدخول في المستقبل',
          '请设置5位数及以上的密码':'يرجى تعيين كلمة مرور مكونة من 5 أرقام أو أكثر',
          '您的密码少于5位，请重新输入':'كلمة المرور الخاصة بك أقل من 5 أحرف ، يرجى إعادة إدخالها',
          ...
          '很抱歉，手机号登录系统正在升级中，请选择其他的登录方式':'عذرا، يتم تحديث نظام تسجيل الدخول إلى رقم الهاتف المحمول. يرجى اختيار طريقة تسجيل دخول أخرى.',
          ...
          '换一个问题':'سؤال آخر',
          '由于LanLa登录系统的优化，请绑定其他的登录方式':'لتحسين نظام تسجيل الدخول إلى LanLa، يرجى ربط طرق تسجيل الدخول الأخرى',
          '其他频道':'قنوات أخرى',
          ...
          '往下滑滑发现更多精彩吧':'المزيد من المحتوى المثير يمكن العثور عليه عند التمرير لأسفل',
          '今日特价':'عرض خاص اليوم',
