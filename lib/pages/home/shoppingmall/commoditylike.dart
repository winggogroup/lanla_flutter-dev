...
class commoditylikePage extends StatefulWidget {
  @override
  createState() => commoditylikeState();

}

class commoditylikeState extends State<commoditylikePage> {
  ...
  Future<void> _fetch() async {
    ...
    var res=await provider.commoditylist(likePage,jsonEncode([]),1);
