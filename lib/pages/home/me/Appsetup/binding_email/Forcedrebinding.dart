    ...
    return Scaffold(
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            SizedBox(height: 50,),
            Container(child:Text('你的邮箱账号'.tr+emaildata['email']+'已被下方账号绑定'.tr,textAlign:TextAlign.center,style: TextStyle(fontSize: 15),),margin: EdgeInsets.fromLTRB(50, 0, 50, 0),),
            ...
            Container(decoration: BoxDecoration(
            ...
            ),margin: EdgeInsets.only(left: 20,right: 20,),padding: EdgeInsets.fromLTRB(20, 25, 20, 25),child: Row(children: [
              Container(width: 69,height: 69,clipBehavior: Clip.hardEdge,decoration: BoxDecoration(  color: Color.fromRGBO(0, 0, 0, 0.05) ,borderRadius: BorderRadius.all(Radius.circular(50))),child:CachedNetworkImage(
              ...
              Expanded(child: Container(child: Column(crossAxisAlignment:CrossAxisAlignment.start,children: [
                Row(mainAxisAlignment:MainAxisAlignment.spaceBetween,children: [
                  Text(emaildata['have_email_user_info']['nickname'],style: TextStyle(fontWeight: FontWeight.w600),),
                  Container(padding: EdgeInsets.all(7),decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(2)),border: Border.all(width: 1,color: Color.fromRGBO(255, 14, 57, 1))),child: Text(
                    '当前绑定'.tr,style: TextStyle(fontSize: 9,color:Color.fromRGBO(255, 14, 57, 1)),),),
                ...
                SizedBox(height: 6,),
                GestureDetector(child: Row(crossAxisAlignment: CrossAxisAlignment.center,children: [Text('账号绑定状态'.tr,style: TextStyle(fontSize: 12,color: Color.fromRGBO(153, 153, 153, 1),height: 1),),SizedBox(width: 5,),Image.asset(!isexpand?'assets/images/xiajiantou.png':'assets/images/shangjiantou.png',width: 12,height: 6,)],),
                  onTap: (){
                  setState(() {
                    isexpand=!isexpand;
                  });
            ...
            if(isexpand)Container(decoration: BoxDecoration(
            ...
            ),margin: EdgeInsets.only(left: 30,right: 30,),padding: EdgeInsets.all(20),child: Column(children: [
              ...
              if(emaildata['have_email_user_info']['login_method_list'][i]['type']!=5)Row(children: [
                ...
                SizedBox(width: 5,),
                Text(emaildata['have_email_user_info']['login_method_list'][i]['name'],style: TextStyle(fontSize: 12,color: Color.fromRGBO(153, 153, 153, 1)),),
            ...
            Container(decoration: BoxDecoration(
              ...
              Expanded(child: Column(crossAxisAlignment:CrossAxisAlignment.start,children: [
                Row(mainAxisAlignment:MainAxisAlignment.spaceBetween,children: [
                  Text(userLogic.userName,style: TextStyle(fontWeight: FontWeight.w600),),
                  Container(padding: EdgeInsets.all(7),decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(2)),border: Border.all(width: 1,color: Color.fromRGBO(238, 238, 238, 1))),child: Text(
                    '当前登录'.tr,style: TextStyle(fontSize: 9,color:Color.fromRGBO(153, 153, 153, 1)),),),
            ...
            GestureDetector(child: Container(
              ...
              decoration: BoxDecoration(color: Color.fromRGBO(249, 249, 249, 1),borderRadius: BorderRadius.all(Radius.circular(37))),
              // child: ElevatedButton(
              //   style: ButtonStyle(
      ...
      appBar: AppBar(
        ...
        title: Text('绑定失败'.tr,style:TextStyle(fontSize: 16)),
        leading: IconButton(
            color: Colors.black,
