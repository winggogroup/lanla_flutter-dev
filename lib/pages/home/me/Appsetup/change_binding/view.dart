...
class ChangeBindingPage extends StatefulWidget {

  createState() => ChangeBindingState();
  @override
...
class ChangeBindingState extends State<ChangeBindingPage> {
  var countrycodelist=[
    {
          ...
          children: [
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  if(widget.state.Verification!=''&&widget.state.phonenumber!=''){
                    EasyLoading.show(
