...
import 'package:lanla_flutter/pages/home/me/Appsetup/AccountSecurity.dart';
...
import 'package:get/get.dart';
class CellPhonePage extends StatefulWidget {
  @override
  createState() => CellPhoneState();
  final logic = Get.put(CellPhoneLogic());
  ContentProvider provider =  Get.put(ContentProvider());
  final state = Get.find<CellPhoneLogic>().state;
}

class CellPhoneState extends State<CellPhonePage> {
  ...
  var type;
  Future<void> dili() async {
    var result = await  widget.provider.positions();
    print('请求接口');
    print(result.statusCode);
    print(result.bodyString);
    Map<String, dynamic> responseData =  jsonDecode(result?.bodyString.toString() ?? '');
    print(responseData["countryCode"]);
    var st =(Position.fromJson(responseData));
  ...
  void initState() {
    super.initState();
    widget.state.clicks.value=true;
    type=Get.arguments["type"];
    if(type==2){
      selectionController.text=Get.arguments['phone'];
      widget.state.phonenumber=Get.arguments['phone'];
    }
    dili();
  }
            ...
            children: [
                      ...
                      // decoration: BoxDecoration(border: Border.all(color: Colors.red)),
                        ...
                        Row(
                          ...
                          showCountryPicker(
                            ...
                            favorite: <String>[widget.state.favorite.value],
                            //Optional. Shows phone code before the country name.
                            showPhoneCode: true,
                            onSelect: (Country country) {
                              widget.state.Areacode.value=country.phoneCode;
                              widget.state.favorite.value=country.countryCode;
                            },
                    ...
                    Container(
                      ...
                      //decoration: BoxDecoration(border: Border.all(color: Colors.red)),
                        ...
                        child: GestureDetector(
                          ...
                          onTap: () {
                            print('889966${widget.state.clicks.value}+${widget.state.phonenumber}');
                            if(widget.state.clicks.value&&widget.state.phonenumber!=''){
                              print('889966');
                              widget.state.clicks.value=false;
                              widget.logic.SendVerificationCode(context);
                            }
                          },
                        )
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    print(widget.state.phonenumber);
                    if(widget.state.Verification!=''&&widget.state.Areacode.value!='' && widget.state.phonenumber!='') {
                      EasyLoading.show(
                          status: 'loading...', maskType: EasyLoadingMaskType.black);

                      FirebaseAuth auth = FirebaseAuth.instance;
                      PhoneAuthCredential credential = PhoneAuthProvider.credential(
                          verificationId: widget.state.verificationId == ''?Get
                              .arguments["verificationId"] : widget.state.verificationId,
                          smsCode: widget.state.Verification);
