        ...
        child: ListView(
          ...
          children: [
            ...
            Container(width: double.infinity,margin: const EdgeInsets.only(left: 20,right: 20),child: Row(children: [
              ...
              // SizedBox(width: 10,),
              Text(conditiondata['label_high_quality_author']['second_page_config']['condition_desc'][0]['title'],style: const TextStyle(fontSize: 15,fontWeight: FontWeight.w700),),
            ],),),
            const SizedBox(height: 10,),
            Container(width: double.infinity,margin: const EdgeInsets.only(left: 20,right: 20),child: Text(conditiondata['label_high_quality_author']['second_page_config']['condition_desc'][0]['desc'],style: const TextStyle(fontSize: 15,),),),
            const SizedBox(height: 10,),
            Container(width: double.infinity,margin: const EdgeInsets.only(left: 20,right: 20),height:30,child: Stack(children: [Positioned(right: 0,child: Container(child: Column(children: [
              Container(
                ...
                child: Text('${conditiondata['label_high_quality_author']['second_page_config']['condition_desc'][0]['current_point']}/${conditiondata['label_high_quality_author']['second_page_config']['condition_desc'][0]['target_point']}',style: const TextStyle(fontSize: 10),),
              ),
            ...
            Container(width: double.infinity,margin: const EdgeInsets.only(left: 20,right: 20),child: Row(children: [
              ...
              // SizedBox(width: 10,),
              Text(conditiondata['label_high_quality_author']['second_page_config']['condition_desc'][1]['title'],style: const TextStyle(fontSize: 15,fontWeight: FontWeight.w700),),
            ],),),
            const SizedBox(height: 10,),
            Container(width: double.infinity,margin: const EdgeInsets.only(left: 20,right: 20),child: Text(conditiondata['label_high_quality_author']['second_page_config']['condition_desc'][1]['desc'],style: const TextStyle(fontSize: 15,),),),
            const SizedBox(height: 10,),
            Container(width: double.infinity,margin: const EdgeInsets.only(left: 20,right: 20),height:30,child: Stack(children: [Positioned(right: 0,child: Container(child: Column(children: [
              Container(
                padding: const EdgeInsets.only(left: 11,right: 11,top: 2,bottom: 2),
                ...
                child: Text('${conditiondata['label_high_quality_author']['second_page_config']['condition_desc'][1]['current_point']}/${ conditiondata['label_high_quality_author']['second_page_config']['condition_desc'][1]['target_point']}',style: const TextStyle(fontSize: 10),),
              ),
              Stack(clipBehavior: Clip.none,children: [
                Container(width: 9,height: 7,),
                Positioned(top: -1,child:Image.asset('assets/images/dwxiajt.png',width: 9,height: 7,))
      ...
      bottomNavigationBar: Container(
        ...
        child: ElevatedButton(
          style: ButtonStyle(
            ...
            backgroundColor: MaterialStateProperty.all(!conditiondata['label_high_quality_author']['second_page_config']['button_disabled']?const Color.fromRGBO(219, 255, 0, 1):const Color.fromRGBO(245, 245, 245, 1)),
          ),
          onPressed: ()  async {
          ...
          child: Text(!conditiondata['label_high_quality_author']['second_page_config']['button_disabled']?'立刻申请'.tr:'申请条件未达成'.tr,style: TextStyle(
            ...
            color: !conditiondata['label_high_quality_author']['second_page_config']['button_disabled']?const Color.fromRGBO(0, 0, 0, 1):const Color.fromRGBO(153, 153, 153, 1),
