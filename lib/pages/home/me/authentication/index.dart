  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body:shujudata==null
        ...
        decoration: const BoxDecoration(color:Color(0xfffffcd9)),
        child:
        ListView(
          ...
          children: [
            Stack(children: [
             ...
             Positioned(child:Container(
               ...
               width: double.infinity,margin: const EdgeInsets.fromLTRB(20, 46, 20, 0),padding: EdgeInsets.fromLTRB(20, 20, 20, imageheight ?? 138.0),child: Column(children: [
               Row(children: [

                 Container(clipBehavior: Clip.hardEdge,alignment: Alignment.center,width: 50,height: 50,decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(50))),child: Image.network(shujudata["label_high_quality_author"]["icon_link"],fit:BoxFit.cover ,),),
                 const SizedBox(width: 15,),
                 Text(shujudata["label_high_quality_author"]["title"],style: const TextStyle(fontSize: 14),)
               ],),
               const SizedBox(height: 10,),
               Container(alignment: Alignment.centerRight,child: Text(shujudata["label_high_quality_author"]["description"],style: const TextStyle(fontSize: 13,color: Color.fromRGBO(153, 153, 153, 1),height:2),),),
               ...
               GestureDetector(child: Container(
                 child: Container(
                   ...
                   decoration: BoxDecoration(
                       color: shujudata["label_high_quality_author"]["button_status"]==3?const Color.fromRGBO(219, 255, 0, 1):const Color.fromRGBO(245, 245, 245, 1),
               ...
               const SizedBox(height: 20,),
               Row(children: [
                 Container(clipBehavior: Clip.hardEdge,alignment: Alignment.center,width: 50,height: 50,decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(50))),child: Image.network(shujudata["label_famous_user"]["icon_link"],fit:BoxFit.cover,),),
                 const SizedBox(width: 15,),
                 Text(shujudata["label_famous_user"]["title"],style: const TextStyle(fontSize: 14),)
               ],),
               const SizedBox(height: 10,),
               Container(alignment: Alignment.centerRight,child: Text(shujudata["label_famous_user"]["description"],style: const TextStyle(fontSize: 13,color: Color.fromRGBO(153, 153, 153, 1),height:2),),),
               const SizedBox(height: 15,),
               GestureDetector(child: Container(
                 child: Container(
                   width: double.infinity,
                   ...
                   padding: const EdgeInsets.only(top: 15, bottom: 15),
                   decoration: BoxDecoration(
                       color: shujudata["label_famous_user"]["button_status"]==3?const Color.fromRGBO(219, 255, 0, 1):const Color.fromRGBO(245, 245, 245, 1),
                       borderRadius: const BorderRadius.all(Radius.circular(170))
                   ),
                   margin: const EdgeInsets.only(left: 28, right: 28),
                   child: Text(
            ...
            Container(margin: const EdgeInsets.only(left: 20,right: 20),child: Text('LanLa认证特权'.tr,style: const TextStyle(fontSize: 15,fontWeight: FontWeight.w700),),),
            const SizedBox(height: 10,),
            Container(width: double.infinity,child: Row(mainAxisAlignment:MainAxisAlignment.spaceEvenly,crossAxisAlignment:CrossAxisAlignment.start,children: [
              Container(width: MediaQuery.of(context).size.width/4,child: Column(children: [
                ...
                Text('达人标识'.tr,textAlign:TextAlign.center,style: const TextStyle(fontSize: 10),)
              ],),),
              Container(width: MediaQuery.of(context).size.width/4,child: Column(children: [
                Image.asset('assets/images/renzhengbs2.png',width: 35,height: 35,),
                Text('流量扶持'.tr,textAlign:TextAlign.center,style: const TextStyle(fontSize: 10),)
              ],),),
              Container(width: MediaQuery.of(context).size.width/4,child: Column(children: [
                Image.asset('assets/images/renzhengbs3.png',width: 35,height: 35,),
                Text('官号推荐'.tr,textAlign:TextAlign.center,style: const TextStyle(fontSize: 10),)
              ],),),
              Container(width: MediaQuery.of(context).size.width/4,child: Column(children: [
                Image.asset('assets/images/renzhengbs4.png',width: 35,height: 35,),
                Text('资源位曝光'.tr,textAlign:TextAlign.center,style: const TextStyle(fontSize: 10),)
              ],),)
            ],),)
          ],
        )
            ...
            content: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 25,),
                    Container(width: double.infinity,alignment: Alignment.center,child: Text('认证申请已提交！'.tr,style: const TextStyle(fontSize: 17,fontWeight: FontWeight.w700),),),
                    const SizedBox(height: 8,),
                    Container(padding: const EdgeInsets.only(left: 26,right: 26),child: Text('LanLa工作人员将在3日内审核后给你提示并给予你相应的头衔哟～'.tr,style: const TextStyle(height: 1.8,fontSize: 14),),),
                    const SizedBox(height: 25,),
                    GestureDetector(child: Container(margin: const EdgeInsets.only(left: 20,right: 20),alignment: Alignment.center,height:50,width: double.infinity,
                      decoration: const BoxDecoration(color: Color.fromRGBO(219, 255, 0, 1),borderRadius: BorderRadius.all(Radius.circular(50))),
