...
//   late TabController channelTabController = TabController(length: 3, vsync: this);
...
//                 }),
//
//                 Container(padding: EdgeInsets.only(left: 20,right: 20),child: ListView.builder(
//                     controller: _scrollController,
//                     itemCount: 10,
//                     itemBuilder: (context, i) {
//                       return Container(
...
//                               height: 20,
//                             ),
//                             Container(alignment: Alignment.centerRight,child: Text('chao能笔记站',style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600),),),
//                             SizedBox(
//                               height: 15,
//                             ),
//                             Container(width: double.infinity,height: 100,decoration: BoxDecoration(color: Colors.red,borderRadius: BorderRadius.circular(10)),)
//                           ],
//                         ),
//                       );
//                     }),),
