...
import '../phone_verification/view.dart';
import 'state.dart';
import '../../../models/Newolduser.dart';
...
class LoginLogic extends GetxController {
  ...
  void onReady() async{
    ...
    // print('225566');
    if(countrycode==null){
      sp.setString("countrycode",countrycodelist.toString());
    }
    // print(countrycode);
  ...
  void verification(phone, area_code,verificationId) async {
    // late List<Newolduser> tags;
    //   var result = await provider.Newandoldusers(phone, area_code);
    //   print('请求接口');
    //   print(result.statusCode);
    //   print(result.bodyString);
    // Map<String, dynamic> responseData =  jsonDecode(result.bodyString.toString());
    // print(responseData);
    // Newolduser st =(Newolduser.fromJson(responseData));
    // // tags =NewolduserfromJson(result.bodyString.toString())
    ...
    //     if(st.data?.uid!=''){
       ...
       print('我想要的数据${bean}');
        ...
        // var jsonMap = jsonDecode(result.bodyString.toString());
        // var photo = Photo.fromJson(jsonMap);
        // print(photo.toString());
        // if(result.bodyString.data!=[]){
        //
        // }
     // }
    }

  void ajverification(phone, area_code) async {
    // late List<Newolduser> tags;
    //   var result = await provider.Newandoldusers(phone, area_code);
    //   print('请求接口');
    //   print(result.statusCode);
    ...
    //     print('${st.data?.uid}');
    //     if(st.data?.uid!=''){
    var bean={'phone':phone,'area_code':area_code};
    Get.to(PhoneVerificationPage(), arguments: bean);
    // }else{
    //   print('112233');
    //   // Get.to(PhoneVerificationPage());
  ...
  ///firebase验证验证码
  void firebaseverification(context,phone,area_code,idToken) async{

    var result = await provider.firebaseVerificationCode(phone, area_code,userLogic.sourcePlatform,idToken);
