...
class _SimpleRecorderState extends State<SimpleRecorder> {
  ...
  String _mPath = 'tau_file.aacADTS';
  ...
  void record() {
    _mRecorder!
        .startRecorder(
      toFile: '1111${ext[Codec.aacADTS.index]}',
      codec: Codec.aacADTS,
  ...
  void uploadyinpin() async {
    ...
    String newThumbnailPath = await AliOssClient()
        .putObject("${dir.path}/1111${ext[Codec.aacADTS.index]}", 'thumb', 'hhhh');
  ...
  void play() {
    ...
    _mPlayer!
        .startPlayer(
        fromURI: '1111${ext[Codec.aacADTS.index]}',
